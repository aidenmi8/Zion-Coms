...
const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    KnownAcpRuntime {
        ...
        cli_install_hint: "Zion talks to Goose through the Goose CLI.",
    ...
    KnownAcpRuntime {
        ...
        cli_install_hint: "Zion talks to Claude Code through the Claude Code CLI.",
        adapter_install_hint: "Zion talks to the Claude Code CLI through an ACP adapter. Install it with: npm install -g @agentclientprotocol/claude-agent-acp.",
    ...
    KnownAcpRuntime {
        ...
        cli_install_hint: "Zion talks to Codex through the Codex CLI.",
        adapter_install_hint: "Zion talks to the Codex CLI through an ACP adapter. Install it with: npm install -g @agentclientprotocol/codex-acp.",
...
pub fn missing_command_message(command: &str, role: &str) -> String {
    ...
    format!(
        "{role} `{command}` was not found. Make sure it is installed and on your PATH. Antivirus software can quarantine bundled binaries — if that happened, restore the file or reinstall Zion. (Source builds: see TESTING.md.)"
    )
}
...
const PRESET_HARNESSES: &[PresetHarness] = &[
    PresetHarness {
        ...
        install_hint: "Zion talks to Cursor through the cursor-agent CLI's ACP mode.",
        underlying_cli: None,
    },
    PresetHarness {
        id: "omp",
        ...
        install_hint: "Zion talks to Oh My Pi through its CLI's ACP mode (omp acp).",
        underlying_cli: None,
    },
    PresetHarness {
        id: "grok",
        ...
        install_hint: "Zion talks to Grok Build through its CLI's agent stdio mode.",
        underlying_cli: None,
    },
    PresetHarness {
        id: "opencode",
        ...
        install_hint: "Zion talks to OpenCode through its CLI's ACP mode (opencode acp).",
        underlying_cli: None,
    },
    PresetHarness {
        id: "kimi",
        ...
        install_hint: "Zion talks to Kimi Code through its CLI's ACP mode (kimi acp).",
        underlying_cli: None,
    },
    PresetHarness {
        id: "amp",
        ...
        install_hint: "Zion talks to the Amp CLI through the amp-acp adapter. Follow the setup guide to install the adapter so the amp-acp command is on your PATH.",
    ...
    PresetHarness {
        ...
        install_hint: "Zion talks to Hermes Agent through its hermes-acp command.",
        underlying_cli: None,
    },
    PresetHarness {
        id: "openclaw",
        ...
        install_hint: "Zion talks to OpenClaw through its ACP mode (openclaw acp), which relies on the OpenClaw Gateway daemon. Follow the setup guide to install both.\n\n\
