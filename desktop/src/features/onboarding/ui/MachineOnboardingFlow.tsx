...
export function MachineOnboardingFlow({
  ...
  return (
    <div
      className={`buzz-onboarding-neutral-theme buzz-zion-community-onboarding buzz-startup-shell flex max-h-dvh items-start justify-center overflow-x-hidden overflow-y-auto px-4 text-foreground ${
        page === "identity"
              ...
              <div className="shrink-0">
                ...
                <p className="mt-5 max-w-[440px] text-sm leading-6 text-foreground/80">
                  {identityLost
                    ...
                    : "If you already have a Zion account, enter your private key below to get started."}
                </p>
              </div>
