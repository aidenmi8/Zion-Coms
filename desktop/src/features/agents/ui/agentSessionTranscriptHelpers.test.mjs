...
test("parsePromptText wraps header-less free text in a single Prompt section", () => {
  ...
  // userText is empty and the title falls through to "Zion event".
  ...
  assert.equal(result.userTitle, "Zion event");
...
test("parsePromptText defaults the title to 'Zion event' when no kind is present", () => {
