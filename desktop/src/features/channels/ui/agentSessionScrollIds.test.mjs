 ...
 *  tree transitively imports a .css file (ZionMotion.tsx →
 *  zion-motion.css) and the test-loader has no CSS stub. The
...
// ZionMotion.tsx → zion-motion.css). The test below verifies the
